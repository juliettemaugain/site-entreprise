...
def get_static_data():
    COLOR_MAP = {
        ...
        "Merlot": "darkblue", 
        "Albarino": "#ffe600",      
        "Cabernet Franc": "#006417",
        "Cinsault":"#ed55a4",
        "Sauvignon Blanc": "lightgreen",
        "Mourvèdre": "brown",
        "Autre": "gray",
    }
...
# --- ENRICHISSEMENT AUTOMATIQUE DES PARCELLES ---
    METADONNEES_ITK = {
        # --- Parcelles déjà tracées ---
        "Syrah Isabelle": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Olivette": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Vio Jardin": {"taille": "Guyot", "objectif": "Blanc vérité", "irrigation": "Goutte à goutte"},
        "Amandier": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "La Plaine": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Calvet": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Syrah du Virage": {"taille": "Cordon", "objectif": "Rosé réserve", "irrigation": "Goutte à goutte"},
        "Roumanissas": {"taille": "Cordon", "objectif": "Rosé réserve", "irrigation": "Goutte à goutte"},
        "Syrah Roumanissas": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Nouveau Plantier Syrah": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Syrah du Muscat": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Syrah Hébram": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Hébram": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Caravane": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Saigne": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Trompet": {"taille": "Palmette", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grand Bardou": {"taille": "Gobelet palissé", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Petit Bardou": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Phylloxera": {"taille": "Guyot (Plantier)", "objectif": "Blanc", "irrigation": "Non renseigné"},
        "Coural": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Terret": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Non renseigné"},
        "Plantier Terret": {"taille": "Palmette", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Vio Source Romaine": {"taille": "Guyot", "objectif": "Blanc vérité", "irrigation": "Goutte à goutte"},
        "Syrah Coural": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Albarino Coural": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Vio Alazet": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Vio Cabane Alazet": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Merlot Alazet": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Albarino Brunaude ": {"taille": "Guyot double", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "CF Brunaude": {"taille": "Guyot", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "La Brunaude": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Plantier Viognier Brunaude": {"taille": "Guyot", "objectif": "Blanc réserve", "irrigation": "Goutte à goutte"},
        "Vio plantier JL": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo JL": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Albarino Baysanis": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardonnay pentu": {"taille": "Haie", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardonnay Gauphi": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Marselan Gauphine": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Syrah Gauphine JL": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Marselan du fond": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Chardonnay 2012": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardonnay 2011": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Gauphine albarino": {"taille": "Guyot double", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Albarino fournic": {"taille": "Guyot (Plantier)", "objectif": "Blanc premium", "irrigation": "Non renseigné"},
        "Albarino Cortes": {"taille": "Guyot (Plantier)", "objectif": "Blanc premium", "irrigation": "Non renseigné"},
        "Marselan Sainte Lucie": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Chardo TRP petite": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo Sainte Lucie": {"taille": "Haie", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo TRP grande": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Albarino sainte Lucie ruine": {"taille": "Cordon", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Syrah Sainte Lucie": {"taille": "TRP / Guyot", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Cinsault Iris": {"taille": "Guyot / TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Albarino Iris": {"taille": "Cordon", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Cinsault Rivière": {"taille": "Guyot", "objectif": "Rosé réserve", "irrigation": "Goutte à goutte"},
        "Chardo oliviers": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Cabernet thézanel": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Santa fee vieille": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo le puit Thezanel": {"taille": "Cordon", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo jeune": {"taille": "Cordon", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Grand Banc et extension": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Chardo derrière maison": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo Bergerie": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Syrah défriche": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Cinsault haut savignac": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Cinsault haut savignac:": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Vio Grand Olivette": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Cinsault Olivette": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Viognier Haut Savignac": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Albarino Savignac": {"taille": "Guyot double", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Cinsault Gravière": {"taille": "Guyot", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Cinsauit Château": {"taille": "Guyot", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Vio Bas Savignac": {"taille": "Haie", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Sauv bas Savignac": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Plantier Route": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Mourvèdre berlan": {"taille": "Gobelet", "objectif": "Rouge", "irrigation": "Non renseigné"},
        "Plantier Grenache Berlan": {"taille": "Gobelet", "objectif": "Rouge", "irrigation": "Non renseigné"},
        "Grenache Berlan": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grenache Virgule": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grenache la Jasse": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grenache Clerc": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Syrah Grande": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Petite Syrah": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Petit Grenache": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grenache Capel": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},

        # --- Parcelles en attente de tracé GPS (Issues du fichier Excel) ---
        "Plantier Syrah roumanissas 1": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Nouveau plantier Syrah rangs courts": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Nouveau plantier Syrah rangs longs": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Amandiers 1 (2ha)": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Amandiers 2 (1,29ha)": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Amandiers plantier": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Olivette 1": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Olivette 2": {"taille": "Palmette", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Petit bardou 1": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Petit bardou 2": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Grand bardou 1 (3,3ha)": {"taille": "Gobelet palissé", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Grand bardou 2 (2,6ha)": {"taille": "Gobelet palissé", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Cabernet-franc Brunaude": {"taille": "Guyot", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Champs Thézanel 2017": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Syrah extension grand banc": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Syrah thézanel grand banc": {"taille": "Cordon", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Chardo jeune Thézanel": {"taille": "Cordon", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo Santa Fée TRP": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Vio Fournic haut JL": {"taille": "Non renseigné", "objectif": "Non renseigné", "irrigation": "Non renseigné"},
        "Vio Jeune JL": {"taille": "Haie", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo 11": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo 12": {"taille": "Guyot", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo 12 2": {"taille": "Haie", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Chardo Baysanis": {"taille": "TRP", "objectif": "Blanc premium", "irrigation": "Goutte à goutte"},
        "Cinsault grande olivette": {"taille": "TRP", "objectif": "Rosé premium", "irrigation": "Goutte à goutte"},
        "Plantier grenache berlan 1": {"taille": "Gobelet", "objectif": "Rouge", "irrigation": "Non renseigné"},
        "Plantier grenache berlan 2": {"taille": "Gobelet", "objectif": "Rouge", "irrigation": "Non renseigné"},
        "Nouvelle syrah fabre": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Syrah fabre": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Goutte à goutte"},
        "Grenache Méou": {"taille": "Cordon", "objectif": "Rouge", "irrigation": "Non renseigné"}
    }

    # boucle insertion infos  parcelles
    for code, info in DATA_PARCELLES.items():
        nom = info["nom"]
        if nom in METADONNEES_ITK:
            info.update(METADONNEES_ITK[nom])
